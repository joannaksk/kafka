...
import org.apache.kafka.common.{ElectionType, KafkaException, Node, TopicPartition, requests}
...
class AuthorizerIntegrationTest extends BaseRequestTest {
  ...
  private def createUpdateMetadataRequest = {
    ...
    new requests.UpdateMetadataRequest.Builder(version, brokerId, Int.MaxValue, Long.MaxValue, Long.MaxValue, partitionStates, brokers, "fakeClusterId").build()
  }
